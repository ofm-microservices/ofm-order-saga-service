...
const (
	insertSessionQuery = `
		INSERT INTO order_saga_sessions (saga_id, order_id, buyer_id, seller_id, seller_username, buyer_email, gig_id, gig_title, picture_file_id, package_id, package_tier, package_description, package_delivery_days, price_cents, currency, status, created_at, updated_at)
		VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
	`

	getSessionByIDQuery = `
		SELECT saga_id, order_id, buyer_id, seller_id, seller_username, buyer_email, gig_id, gig_title, picture_file_id, package_id, package_tier, package_description, package_delivery_days, price_cents, currency, status, created_at, updated_at

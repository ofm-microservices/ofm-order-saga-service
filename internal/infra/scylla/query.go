...
const (
	insertSessionQuery = `
		INSERT INTO order_saga_sessions (saga_id, order_id, buyer_id, seller_id, buyer_email, realtime_connection_id, gig_id, gig_title, package_id, package_tier, package_description, package_delivery_days, price_cents, currency, status, created_at, updated_at)
		VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
	`
